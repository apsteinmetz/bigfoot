...
states_map<-states_map_50_nested %>% 
  unnest()  %>% 
...
```{r}
states <- states_map #as_data_frame(map_data("state"))
#arrests <- as_data_frame(USArrests)
...
ggplot(choro, aes(long, lat)) +
 ...
 # coord_map("albers",  at0 = 45.5, lat1 = 29.5)
  coord_map()+ scale_fill_distiller(name="Bigfoot\nSightings", palette="Greens",direction = 1)+theme_minimal()
```
