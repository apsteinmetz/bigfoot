...
```
Load BFRO sigh.ting report from Kaggle dataset. Reorder so that `title`,which is the description text is the last column. Add empty `region` field that we will populate with the state later. Filter for bad values.
