...
startYear<-1980
inputYr<-2001
fills<-c(rep("grey50",inputYr-startYear-1),"red",rep("grey50",thisYear-inputYr))
subsetYear<-state_sum %>% filter(Year>startYear,Year<thisYear+1) %>% group_by(Year) %>% summarize(count=sum(count))
