...
```{r}
#remove unneeded nodes that might have give duplicate information.
kml %>% xml_find_all(".//Folder/Placemark[name[contains(.,'Location Boundaries')]]") %>% 
...
states_map_52<-download.file("http://www2.census.gov/geo/tiger/GENZ2016/shp/cb_2016_us_county_20m.zip","gis/state_polygons.zip",mode="wb")
unzip("gis/state_polygons.zip")
